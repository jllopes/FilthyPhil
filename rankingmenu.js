...
function writeRankingHtml()
{
	for(var i = 1; i<11; i++) {
		var stringNick = i + "nick";
		var nick = sessionStorage.getItem(stringNick);
		var score = sessionStorage.getItem(i);
		document.getElementById("highscoreText" + i).innerHTML = i + ": " + nick + " - " + score+ "points" + "\n";
	}
}

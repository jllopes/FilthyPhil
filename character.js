...
class Character
{
		constructor(ctx,canvasWidth,canvasHeight)
		{
			...
			this.runSpriteImage.src = "../Assets/Dog_Run.png";
			...
			this.jumpSpriteImage.src = "../Assets/Dog_Jump.png";
			...
			this.caughtSpriteImage.src = "../Assets/Dog_Caught.png";
			...
			this.flySpriteImage.src = "../Assets/Dog_Fly.png";
